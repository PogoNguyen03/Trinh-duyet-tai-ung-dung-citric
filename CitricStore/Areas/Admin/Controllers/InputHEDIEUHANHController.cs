...
namespace CitricStore.Areas.Admin.Controllers
{
    public class InputHEDIEUHANHController : Controller
    {
        ...
        // GET: Admin/InputHEDIEUHANH
        public ActionResult Index()
        {
            return View(db.HEDIEUHANHs.ToList());
        }

        // GET: Admin/InputHEDIEUHANH/Details/5
        ...
        // GET: Admin/InputHEDIEUHANH/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/InputHEDIEUHANH/Create
        ...
        // GET: Admin/InputHEDIEUHANH/Edit/5
        ...
        // POST: Admin/InputHEDIEUHANH/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/InputHEDIEUHANH/Delete/5
        ...
        // POST: Admin/InputHEDIEUHANH/Delete/5
