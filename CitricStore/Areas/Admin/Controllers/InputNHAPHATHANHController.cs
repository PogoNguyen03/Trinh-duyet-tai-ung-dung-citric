...
namespace CitricStore.Areas.Admin.Controllers
{
    public class InputNHAPHATHANHController : Controller
    {
        ...
        // GET: Admin/InputNHAPHATHANH
        public ActionResult Index()
        {
            return View(db.NHAPHATHANHs.ToList());
        }

        // GET: Admin/InputNHAPHATHANH/Details/5
        ...
        // GET: Admin/InputNHAPHATHANH/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/InputNHAPHATHANH/Create
        ...
        // GET: Admin/InputNHAPHATHANH/Edit/5
        ...
        // POST: Admin/InputNHAPHATHANH/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/InputNHAPHATHANH/Delete/5
        ...
        // POST: Admin/InputNHAPHATHANH/Delete/5
